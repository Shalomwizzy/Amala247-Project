                ...
                <div class="row mt-5 gap-5">
                    ...
                    <div class="card col-lg-3 col-md-6 mb-1">
                        ...
                        >
                            ...
                            <button
                                type="submit"
                                class="wishlist-button btn p-0"
                            >
                            <span class="wishlist-heart" onclick="toggleWishlistColor({{ $product->id }}, event)">
                                <i id="heartIcon{{ $product->id }}" class="fa-solid fa-heart{{ $product->inWishlist ? ' text-danger' : ' text-dark' }}"></i>
                            </span>
                       ...
                       <form action="{{ route('wishlist.add', ['product' => $product->id]) }}" method="POST" class="wishlist-form">
                            @csrf
                            <button type="submit" class="wishlist-button btn p-0">
                                <span class="wishlist-heart" onclick="toggleWishlistColor({{ $product->id }})">
                                    <i id="heartIcon{{ $product->id }}" class="fa fa-heart{{ $product->inWishlist ? ' text-danger' : ' text-dark' }}"></i>
                                </span>
